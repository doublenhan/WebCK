...
namespace WebMVC.CustomAuthentication
{
    public class CustomMemberShip : MembershipProvider
    {
        public override bool ValidateUser(string email, string password)
        {
            ...
            {
                var account = (from us in dbContext.Accounts where us.Email == email && us.PassWord == password && us.isActive == true select us).FirstOrDefault();
        ...
        public override MembershipUser GetUser(string email, bool userIsOnline)
        {
            using (data dbContext = new data())
            {
                var user = (from us in dbContext.Accounts
        ...
        public override string GetUserNameByEmail(string email)
        {
            using (data dbContext = new data())
            {
                string username = (from u in dbContext.Accounts
